...
public:
    ...
    TissueBacteria () ;
    vector<vector<double> > Cal_Diffusion2D (double xMin, double xMax, double yMin, double yMax,int nGridX, int nGridY ,vector<vector<double> > sources) ;
    void Myxo () ;
    void Spring() ;
